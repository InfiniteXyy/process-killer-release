    ...
    <>
      ...
      <main className="text-center">
        ...
        <a
          ...
          className="inline-block rounded-lg bg-gray-200 px-3 py-2 text-sm font-medium hover:bg-gray-300"
        >
          Download (Windows)
        </a>
      ...
      <footer className="mt-8 text-center text-xs">
        ...
        <div className="mt-4 flex justify-center space-x-4 text-xl">
          <a href='https://github.com/InfiniteXyy' className="i-[logos-github-icon]" />
